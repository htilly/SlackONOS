...
function inferTargetTypeForCommand(command) {
  ...
  if (['play', 'pause', 'resume', 'stop', 'flush', 'shuffle', 'normal', 'setvolume', 'setcrossfade', 'setconfig', 'remove', 'move', 'gong', 'vote', 'flushvote', 'current', 'list', 'volume', 'help'].includes(command)) {
    return 'command';
  }
  return 'unknown';
}
