...
function createCommandRegistry(deps) {
  ...
  return new Map([
    ...
    ['resetvotes', { fn: (args, ch, u) => commandHandlers.resetVotes(args, ch, u), admin: true, aliases: ['clearvotes', 'votereset'] }],
    ...
    ['featurerequest', { fn: featurerequest, admin: true, aliases: ['feuturerequest'] }],
    ['fr', { fn: featurerequest, admin: true }],
